...
export class ViewField extends GameElement {
    ...
    private intermediariosNecesarios:Array<boolean> = new Array();
    ...
    public updateViewShadow(obj: any, x:number, y:number) {
        ...
        if (obj instanceof Rect) {
            ...
            this.intermediariosNecesarios.push(true);
            ...
            this.showShadow.push(true);
            this.intermediariosNecesarios.push(false);
    ...
    public drawShadowShapes(ctx) {
        ...
        this.shadows.forEach(shadow => {
            if(this.showShadow[i]){
                ...
                var intermedioNecesario = this.intermediariosNecesarios[i] && (pOut1[0] > this.getX() || pOut1[1] < this.getY());
                if (intermedioNecesario) var intermedio = PHY.createRectWithAngle(shadow[0], UMI.getUMIsOutOfRange()*2, shadow[2]-(30/57.2957795));
                ...
                ctx.beginPath();       
                    ...
                    if (intermedioNecesario) ctx.lineTo(UMI.screenX(intermedio[0]), UMI.screenY(intermedio[1]));
    ...
    public drawRestField(ctx){
        ...
        var r1 = PHY.rotatePoint(UMI.screenXUMI(this.getX()), UMI.screenYUMI(this.getY()), UMI.getUMIsWidth()*8, UMI.getUMIsWidth()*4, a + this.currentAngle);
        var r1e = PHY.rotatePoint(UMI.screenXUMI(this.getX()), UMI.screenYUMI(this.getY()), UMI.getUMIsWidth()*8, UMI.getUMIsWidth()*4, a + this.currentAngle + UMI.RADIANSOF90);
        var r1e2 = PHY.rotatePoint(UMI.screenXUMI(this.getX()), UMI.screenYUMI(this.getY()), UMI.getUMIsWidth()*8, UMI.getUMIsWidth()*4, a + this.currentAngle + UMI.RADIANSOF180);
        var r1e3 = PHY.rotatePoint(UMI.screenXUMI(this.getX()), UMI.screenYUMI(this.getY()), UMI.getUMIsWidth()*8, UMI.getUMIsWidth()*4, a + this.currentAngle + UMI.RADIANSOF180 + UMI.RADIANSOF90);
        
        var r2 = PHY.rotatePoint(UMI.screenXUMI(this.getX()), UMI.screenYUMI(this.getY()), UMI.getUMIsWidth()*8, UMI.getUMIsWidth()*4, a - this.currentAngle);
