...
var ViewField = (function (_super) {
    ...
    function ViewField() {
        ...
        _this.miniumAngle = 0;
        _this.intermediariosNecesarios = new Array();
    ...
    ViewField.prototype.drawShadowShapes = function (ctx) {
        ...
        this.shadows.forEach(function (shadow) {
            if (_this.showShadow[i]) {
                ...
                var intermedioNecesario = _this.intermediariosNecesarios[i] && (pOut1[0] > _this.getX() || pOut1[1] < _this.getY());
                if (intermedioNecesario)
                    var intermedio = PHY.createRectWithAngle(shadow[0], UMI.getUMIsOutOfRange() * 2, shadow[2] - (30 / 57.2957795));
                ...
                if (intermedioNecesario)
                    ctx.lineTo(UMI.screenX(intermedio[0]), UMI.screenY(intermedio[1]));
